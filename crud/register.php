...
<html lang="en">
    ...
    <body>
        <div class="container my-5">
            <form class="row col-12 col-md-4" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>"  autocomplete="off" enctype="multipart/form-data">
                <div class="h2 px-0">Sign Up.</div>
                ...
                <span class="text-danger my-2 px-0"> <?php echo $fnameError; ?> </span>
                ...
                <div class="d-flex mb-3 px-0">
                    ...
                    <span class="text-danger my-2 px-0"> <?php echo $dateError; ?> </span>

                    <input class='form-control w-50' type="file" name="picture" >
                    <span class="text-danger my-2 px-0"> <?php echo $picError; ?> </span>
                </div>

                <input type="password" name="pass" class="form-control" placeholder="Enter Password" maxlength="15"  />
                <span class="text-danger my-2 px-0"> <?php echo $passError; ?> </span>
                <button type="submit" class="btn btn-block my_bg" name="btn-signup">Sign Up</button>
                <a class="fw-bold px-0 my-5" href="login.php">Sign in Here...</a>
            </form>
        </div>
    </body>
</html>